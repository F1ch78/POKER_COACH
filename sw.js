...
const SHELL = ['./', 'index.html', 'app.js', 'brain.js', 'kb.js', 'tour-engine.js', 'icm.js', 'sng.js', 'store.js', 'poker.js', 'ranking.js',
  'manifest.json', 'icon-192.png', 'icon-512.png', 'spin_gold.md', 'turniry.md'];
